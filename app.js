...
app.configure( function() {
	...
	app.use(express.cookieParser('sonos-fuel-throttle-nodeSignedCookieSecret'));

	// TODO: MaxAge for cookie based on token exp?
	app.use(express.cookieSession({secret: "sonos-fuel-throttle-nodePreventCookieTamperingSecret", cookie:{ httpOnly: true, signed: true }}));
