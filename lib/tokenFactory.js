    ...
    if( _.isFunction( fuelInstance ) ) {
        fuelInstance( function( error, response, tokenData ) {
            ...
            if( tokenData ) {
                ...
                res.cookie( 'sonos-fuel-throttle-node', {id: csid, oAuthToken: tokenData.accessToken }, {signed: true, expiresIn: tokenData.expiresIn} );
...
TokenFactory.prototype._getSessionIdFromCookie = function( req ) {
    ...
    var clientSessionId = req.signedCookies['sonos-fuel-throttle-node'].id;
